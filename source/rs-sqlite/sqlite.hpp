...
namespace RS::Sqlite {
    ...
    private:
        ...
        void Query::set(const std::string& name, const T& value) {
            ...
            if (index == 0)
                throw InvalidArgument("Unknown query parameter: " + Format::quote(name));
        ...
        void Query::bind_helper(int index, const T& arg1, const Args&... args) {
            ...
            if constexpr (std::is_same_v<T, std::nullptr_t>)
                ...
                static_assert(TL::dependent_false<T>, "Unknown parameter type in Query::bind()");
    ...
    private:
        ...
        void Result::get(int col, T& t) const {
            if constexpr (std::is_integral_v<T>)
                ...
                static_assert(TL::dependent_false<T>, "Unknown parameter type in Result::get()");
        }
    ...
    private:
        ...
        public TL::InputIterator<Result::iterator, const Row> {
        public:
            iterator() = default;
